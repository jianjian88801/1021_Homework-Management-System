          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="课程评价" prop="kechengpingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="课程评价"
                  v-model="ruleForm.kechengpingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kechengpingjia" label="课程评价" prop="kechengpingjia">
                    <span>{{ruleForm.kechengpingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>

          ...
          <el-form-item class="input" label="职称" prop="zhicheng">
              <el-input v-model="ruleForm.zhicheng" 
                placeholder="职称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任教课程" prop="renjiaokecheng">
          <el-input v-model="ruleForm.renjiaokecheng" 
              placeholder="任教课程" clearable  :readonly="ro.renjiaokecheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任教课程" prop="renjiaokecheng">
              <el-input v-model="ruleForm.renjiaokecheng" 
                placeholder="任教课程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhicheng = true;
            continue;
	            	            ...
	            	            if(o=='renjiaokecheng'){
            this.ruleForm.renjiaokecheng = obj[o];
	    this.ro.renjiaokecheng = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){

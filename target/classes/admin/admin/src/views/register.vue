  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">课程作业管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="职称" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.zhicheng" autocomplete="off" placeholder="职称" type="text" />
												...
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">任教课程</div>
			   <div class="input-container">
			     <input v-model="ruleForm.renjiaokecheng" class="input" type="text" placeholder="任教课程">
			   </div>
			 </div> -->
			<el-form-item label="任教课程" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.renjiaokecheng" autocomplete="off" placeholder="任教课程" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
